            ...
            <WShut3>
                <InputData>
                    <WShutData>
                        <CaseList>
                            <Case>
                                <DesigneSeismicCoefficient>

    */

    static public class editor_031
    {
        ...
        static public void Edit(XmlDocument xmlDoc, double value )
        {
            ...
            var DesigneSeismicCoefficient = helper.getXmlElement(Case, "DesigneSeismicCoefficient");

            DesigneSeismicCoefficient.InnerText = value.ToString("E");
